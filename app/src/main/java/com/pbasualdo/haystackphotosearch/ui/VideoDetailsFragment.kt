...
import com.pbasualdo.haystackphotosearch.ui.main.MainActivity
...
class VideoDetailsFragment : DetailsSupportFragment() {
    ...
    private var mSelectedMovie: Photo? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mSelectedMovie = activity!!.intent.getSerializableExtra(DetailsActivity.MOVIE) as Photo
    ...
    private fun initializeBackground(movie: Photo?) {
